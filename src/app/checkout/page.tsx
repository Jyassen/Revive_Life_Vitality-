...
function isSubscriptionItem(item: any): boolean {
...
function CheckoutContent() {
	...
	const createPaymentIntent = async (customerData: any, shippingData: any) => {
		try {
			setLoading(true)
	...
	const createSubscription = async (customerData: any, shippingData: any) => {
		try {
			setLoading(true)
