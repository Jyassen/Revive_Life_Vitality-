  ...
  const footerLinks = [
    {
      title: "Shop",
      links: [
        { name: 'All Products', href: '#purchase-options' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Why we Stand Out', href: '#comparison' },
    ...
    },
    {
      title: "Help",
      links: [
        { name: 'Shipping', href: '#', onClick: true },
        { name: 'Privacy Policy', href: '/legal/Privacy_Policy.pdf' },
        { name: 'Terms of Service', href: '/legal/Terms_of_Service.pdf' },
      ]
    }
  ];
      ...
      <div className="container-custom">
                ...
                {section.links.map((link, j) => (
                  <li key={j}>
                    {link.onClick ? (
                      <button
                        type="button"
                        onClick={() => alert('Guaranteed fresh shipping! We make sure your elixirs arrive quick to your doorstep - $10 flat rate')}
                        className="text-left text-gray-300 hover:text-white text-sm transition-colors"
                      >
                        {link.name}
                      </button>
                    ) : (
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex space-x-6 mb-4 md:mb-0">
            ...
            <a href="https://instagram.com/revivelifevitality" target="_blank" rel="noopener noreferrer" aria-label="Instagram @revivelifevitality" className="text-gray-400 hover:text-white">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-xs text-gray-400">Phone: 631-397-2010</p>
